...
class Config:
<<<<<<< HEAD
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:hyun4662@localhost/handsome_f4" # DB 연결
=======
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:11111111@localhost/handsome_f4" # DB 연결
>>>>>>> upstream/main
